...
# I# I/O paths
run_folders = {
    "model_path": '/home/yuandou/test/breakhis100x_FLC4/CAE_100X/check/FL.CAE/'
    , "results_path": '/home/yuandou/test/breakhis100x_FLC4/CAE_100X/check/FL.CAE/'
...
class CBIRClient_breaKHis100x(fl.client.NumPyClient):
    ...
    def get_parameters(self, config):
        ...
        with open(dirctory+'/res_get_paras_client4_breaKHis100x.csv', 'a', encoding='UTF8') as f:
            writer = csv.writer(f)
...
# Start CBIR client
fl.client.start_numpy_client(server_address=server_address, client=CBIRClient_breaKHis100x())
