...
stime2trainmodel, etime2trainmodel = train(my_VAE, trainloader, valloader, epochs=epochs, round_idx=1)
print("\nlocal epochs: ", epochs, "Start local training at ", stime2trainmodel, "end at ", etime2trainmodel)
