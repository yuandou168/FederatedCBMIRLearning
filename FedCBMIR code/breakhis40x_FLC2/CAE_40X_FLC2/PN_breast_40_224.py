...
# I# I/O paths
run_folders = {
    # "tsv_path": "C:/Users/Zahra/Downloads/archive/BreaKHis_40X_image_name.csv"
    ...
    # , "data_path": "C:/Users/Zahra/Downloads/archive/BreaKHis_400X/images/"
#      "model_path": '/home/zahra/breakhis40x_1fold/'
#     , "results_path": '/home/zahra/breakhis40x_1fold/'
#     , "log_filename": '/home/zahra/breakhis40x_1fold/log_breast.csv'
# }
...
label2=[]
# df_pneumo_2d = pd.read_csv(r"/home/zahra/breakhis40x/BreaKHis_40X.csv")
...
# Saving Training set
# x_train.to_csv (r'/home/zahra/breakhis40x_1fold/x_train_breast40x.csv', index = True, header=True)
# x_val.to_csv (r'/home/zahra/breakhis40x_1fold/x_val_breast40x.csv', index = True, header=True)
# x_test.to_csv (r'/home/zahra/breakhis40x_1fold/x_test_breast40x.csv', index = True, header=True)
...
print("start at: ", stime2trainmodel, "end at: ", etime2trainmodel, "duration is:", duration)
