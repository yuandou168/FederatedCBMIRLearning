...
run_folders = {
     ...
     "model_path": '/home/yuandou/test/breakhis400x_FLC1/CAE_400X/check/CL.CAE/'
    , "results_path": '/home/yuandou/test/breakhis400x_FLC1/CAE_400X/check/CL.CAE/'
...
with open(dirctory+'/res_get_timecost_client3_breaKHis_200x.csv', 'a', encoding='UTF8') as f:
    writer = csv.writer(f)
