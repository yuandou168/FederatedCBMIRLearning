...
# I# I/O paths
run_folders = {
   "model_path": '/home/yuandou/test/breakhis400x_FLC1/CAE_400X/check/FL.CAE/'
    , "results_path": '/home/yuandou/test/breakhis400x_FLC1/CAE_400X/check/FL.CAE/'
    , "log_filename": '/home/yuandou/test/breakhis400x_FLC1/CAE_400X/check/log_breast.csv'
}
...
label2=[]
df_pneumo_2d = pd.read_csv(r"/home/yuandou/test/archive/train/BreaKHis_400X.csv")
...
class CBIRClient_breaKHis400x(fl.client.NumPyClient):
    ...
    def get_parameters(self, config):
        ...
        with open(dirctory+'/res_get_paras_client1_breaKHis400x.csv', 'a', encoding='UTF8') as f:
            writer = csv.writer(f)
    ...
    def fit(self, parameters, config):
        ...
        dirctory = run_folders["model_path"] + run_folders["exp_name"] 
        with open(dirctory+'/res_fit_client1_breaKHis400x.csv', 'a', encoding='UTF8') as f:
            writer = csv.writer(f)
...
# Start CBIR client
fl.client.start_numpy_client(server_address=server_address, client=CBIRClient_breaKHis400x())
