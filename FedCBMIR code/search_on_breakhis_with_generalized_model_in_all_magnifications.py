...
#Directions
args1 = {
	"index": "C:/Users/Zahra/Downloads/archive/BreaKHis_400X/index128.csv"
}

# load our autoencoder from disk
run_folders1 = {
    "weights_path":"/home/zahra/breakhis40x/final_models_of_FDL_CBIR_breakhis/final_models_of_FDL_CBIR_breakhis/FedCBMIR_VAE_weights_40x_FLC2.h5",
...
trainX = data_generator_train.flow_from_dataframe(dataframe=pd.read_csv('/home/zahra/breakhis40x/final_models_of_FDL_CBIR_breakhis/final_models_of_FDL_CBIR_breakhis/4_train_magnification_merged_name.csv'),
                                                  directory='/home/zahra/archive_40X_400X/beaKHis_images/',
                                                  x_col='Image_name',
                                                 y_col=classes,
...
testX = data_generator_test.flow_from_dataframe(dataframe=pd.read_csv('/home/zahra/breakhis40x/final_models_of_FDL_CBIR_breakhis/final_models_of_FDL_CBIR_breakhis/4_test_magnification_merged_label.csv'),
                                               directory='/home/zahra/archive_40X_400X/beaKHis_images/',
                                               x_col='Image_name',
                                               y_col=classes,
                                               batch_size=batch_size,
...
def load_model_AD1(self):
        with open('/home/zahra/breakhis40x/final_models_of_FDL_CBIR_breakhis/final_models_of_FDL_CBIR_breakhis/FedCBMIR_VAE_model_40x_FLC2.pkl', 'rb') as f:
