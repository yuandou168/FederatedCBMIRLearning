...
#Directions
args1 = {
	"index": "/home/yuandou/test/CBIR/check/CAE.VAE.beforeTSNE/exp_0003/index128.csv"
}
run_folders1 = {
    "weights_path":"/home/yuandou/test/CBIR/check/CAE.VAE.beforeTSNE/exp_0003/weights/VAE_weights.h5",
    "tsv_path_test": "/home/yuandou/test/CBIR/SICAPv2/x_val.csv",
    "tsv_path_train":"/home/yuandou/test/CBIR/SICAPv2/x_val.csv",
}
#Reading Data
batch_size = 1
backbone = 'fsconv'
classes = ['NC', 'G3', 'G4', 'G5']
input_shape = (128, 128, 3)     #size of each image
...
trainX = data_generator_train.flow_from_dataframe(dataframe=pd.read_csv('/home/yuandou/test/CBIR/SICAPv2/x_train.csv'),
                                                 directory='/home/yuandou/test/CBIR/SICAPv2/images',
                                                 x_col='image_name',
                                                 y_col=classes,
...
testX = data_generator_test.flow_from_dataframe(dataframe=pd.read_csv('/home/yuandou/test/CBIR/SICAPv2/partition/Test/Test.csv'),
                                               directory='/home/yuandou/test/CBIR/SICAPv2/images/',
                                               x_col='image_name',
                                               y_col=classes,
                                               batch_size=batch_size,
...
def load_model_AD1(self):
        with open('/home/yuandou/test/CBIR/check/CAE.VAE.beforeTSNE/exp_0003/VAE_model.pkl', 'rb') as f:
...
preds_top = np.argmax(end_list_similar, axis=1)  # Predictions (Label)
refs = np.argmax(list_query, 1)  # References
...
cm_search = []
cm_search1 = confusion_matrix(refs, preds_top)
cm_search = confusion_matrix(refs, preds_top, labels= [0, 1, 2, 3])
confusionmatrix = confusion_matrix(refs, preds_top, labels= [0, 1, 2, 3])
print("cm_search")
print(cm_search)
#####
...
disp = ConfusionMatrixDisplay(confusion_matrix = cm_search,
...
cm_search1 = []
labels1= ["NC", "G3", "G4", "G5"]
cm_search1 = confusion_matrix(refs, preds_top, labels= [0, 1, 2, 3])
print("cm_search")
print(cm_search1)
