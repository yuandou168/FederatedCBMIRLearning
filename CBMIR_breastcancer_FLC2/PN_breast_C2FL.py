...
# I# I/O paths
run_folders = {
    # "tsv_path": "C:/Users/Zahra/Downloads/archive/BreaKHis_400X/train/train/train.csv"
    # "tsv_path": "/home/yuandou/test/BreaKHis 400X/train/train/train.csv"    # the whole 400X dataset
    "tsv_path": "/home/yuandou/test/BreaKHis 400X/train/train/x_train_Break_FDL_CL2.csv" # the partial dataset saved in the whole 400X dataset
    ...
    , "tsv_path_test": "/home/yuandou/test/BreaKHis 400X/test/test/test.csv"    # the test dataset 
    , "data_path": "/home/yuandou/test/BreaKHis 400X/images/"
    , "model_path": '/home/yuandou/test/CBMIR_breastcancer_FLC2/check/FL.CAE.VAE.beforeTSNE/'
    , "results_path": '/home/yuandou/test/CBMIR_breastcancer_FLC2/check/FL.CAE.VAE.beforeTSNE/'
    , "log_filename": '/home/yuandou/test/CBMIR_breastcancer_FLC2/check/FL.CAE.VAE.beforeTSNE/log_breast_cancer.csv'
}
...
# df_pneumo_2d.columns = ['image_name', 'label']
df_pneumo_2d.columns = ['index', 'image_name', 'label']
