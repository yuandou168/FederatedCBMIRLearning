...
run_folders = {
    ...
    "tsv_path": "/home/yuandou/test/BreaKHis 400X/train/train/x_train_Break_FDL_CL1.csv" # the partial dataset saved in the whole 400X dataset
    ...
    , "model_path": '/home/yuandou/test/CBMIR_breastcancer_FLC1/check/FL.CAE.VAE.beforeTSNE/'
    , "results_path": '/home/yuandou/test/CBMIR_breastcancer_FLC1/check/FL.CAE.VAE.beforeTSNE/'
    , "log_filename": '/home/yuandou/test/CBMIR_breastcancer_FLC1/check/FL.CAE.VAE.beforeTSNE/log_breast_cancer.csv'
}
